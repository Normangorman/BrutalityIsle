...
void onInit(CBlob@ this)
{
...

	{
		...
		s.crate_icon = 4;
		AddRequirement(s.requirements, "blob", "mat_wood", "Wood", COST_WOOD_CATAPULT);
	}
	{
		...
		AddRequirement(s.requirements, "blob", "mat_gold", "Gold", COST_GOLD_BALLISTA);
	}
	{
		ShopItem@ s = addShopItem(this, "Ballista Ammo", "$mat_bolts$", "mat_bolts", "$mat_bolts$\n\n\n" + descriptions[15], false, false);
		s.crate_icon = 5;
		AddRequirement(s.requirements, "blob", "mat_stone", "Stone", COST_STONE_BALLISTA_AMMO);
	}
	{
		...
		s.buttonwidth = 2;
		s.buttonheight = 1;
		AddRequirement(s.requirements, "blob", "mat_gold", "Gold", COST_GOLD_BALLISTA_UPGRADE);
