// Brutality Isle added some logging 
...
void onTick(CMovement@ this)
{
    ...
    if (blob.getName() == "zombie_chicken")
    {
	...
	if (left)
	{
        if (blob.getName() == "zombie_chicken")
        {
            //log("onTick", blob.getName() + " left pressed");
        }
	...
	if (right)
	{
        if (blob.getName() == "zombie_chicken")
        {
            //log("onTick", blob.getName() + " right pressed");
        }
		blob.AddForce(Vec2f(1.0f * vars.walkForce.x, vars.walkForce.y));
	}
