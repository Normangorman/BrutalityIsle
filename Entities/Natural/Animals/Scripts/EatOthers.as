// Brutality isle modded to set a biting tag when bite starts
// eating other things
...
void onInit(CBlob@ this)
{
	...
	{
        //log("onInit", "'names not to eat' doesn't exist for: " + this.getName());
    ...
    this.set_u32("last bite time", 0);

	if (!this.exists("bite freq"))
...
{
    //log("Bite", this.getName() + " biting: " + other.getName());
	bool facing_left = this.isFacingLeft();
    ...
    this.set_u32("last bite time", getGameTime());
}
