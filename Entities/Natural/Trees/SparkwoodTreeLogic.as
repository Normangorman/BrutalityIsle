...
void GrowSprite(CSprite@ this, TreeVars@ vars)
{
	...
	for (uint i = 0; i < segments.length; i++)
	{
		...
		if (segment !is null && !segment.gotsprites)
		{
			...
			{
				CSpriteLayer@ newsegment = this.addSpriteLayer("segment " + i, "SparkwoodTree.png" , 16, 16, 0, 0);
			...
			{
				CSpriteLayer@ newsegment = this.addSpriteLayer("leaves " + i, "SparkwoodTree.png" , 32, 32, 0, 0);
			...
			else if (segment.grown_times == 5)
			{
				...
				{
					f32 flipsign = 1.0f;
					CSpriteLayer@ newsegment = this.addSpriteLayer("roots", "SparkwoodTree.png" , 32, 16, 0, 0);
				...
				{
					bool flip = false;
					CSpriteLayer@ newsegment = this.addSpriteLayer("leaves side " + i, "SparkwoodTree.png" , 32, 32, 0, 0);
					...
					if (XORRandom(2) == 0)
					{
						CSpriteLayer@ secondnewsegment = this.addSpriteLayer("leaves doubleside " + i, "SparkwoodTree.png" , 32, 32, 0, 0);
